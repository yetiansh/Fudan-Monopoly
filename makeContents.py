...
sites = [Site(name="第三教学楼", text="听课", effect=[0, -1, 0, 1], isCompulsory=False),
         ...
         Site(name="恒隆物理楼", text="做实验", effect=[0, -1, 0, 1], isCompulsory=False),
